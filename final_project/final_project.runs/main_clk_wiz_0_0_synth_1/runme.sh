...
HD_PWD='C:/Users/Nathan/Desktop/cs152b/cs152b/final_project/final_project.runs/main_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_clk_wiz_0_0.tcl
