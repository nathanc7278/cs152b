...
HD_PWD='C:/Users/Nathan/Desktop/cs152b/cs152b/final_project/final_project.runs/main_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_mdm_1_0.tcl
