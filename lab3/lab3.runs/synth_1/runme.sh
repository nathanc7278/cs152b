...
HD_PWD='C:/Users/Nathan/Desktop/cs152b/cs152b/lab3/lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log part1_hello_world_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source part1_hello_world_wrapper.tcl
